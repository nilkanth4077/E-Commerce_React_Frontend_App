...
export default function ProductDetails() {
  ...
  const getProduct = (id) => {
    return axios
      .get(`${BASE_URL}/product/get/${id}`) // Correct API endpoint
      .then((res) => {
      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem] justify-center">
              <img
                alt=""
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-lg lg:text-xl opacity-60 text-grey-900 pt-1">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">618 Ratings</p>
                  <p className="text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:cursor-pointer">
                    135 Reviews
                  </p>
                </div>
              </div>
